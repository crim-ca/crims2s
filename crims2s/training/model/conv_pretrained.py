...
from .conv import DistributionConvPostProcessing
...
class FCNPreTrained(PretrainedModelWrapper):
    ...
    def __init__(self, in_features):
        ...
        super().__init__(fcn, in_features)
...
class TercilesFCNPostProcessing(DistributionModelAdapter):
    ...
    def __init__(self, in_features):
        fcn = DistributionFCNPostProcessing(in_features)
        super().__init__(fcn)
